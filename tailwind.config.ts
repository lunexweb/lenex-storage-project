  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        navy: { DEFAULT: "hsl(var(--navy))", foreground: "hsl(var(--navy-foreground))", light: "hsl(var(--navy-light))" },
        sidebar: {
      ...
      keyframes: {
        ...
        "highlight": { "0%": { backgroundColor: "hsl(38 92% 50% / 0.15)" }, "100%": { backgroundColor: "transparent" } },
        "pop": { "0%": { transform: "scale(0.8)", opacity: "0" }, "50%": { transform: "scale(1.05)" }, "100%": { transform: "scale(1)", opacity: "1" } },
      },
      animation: {
